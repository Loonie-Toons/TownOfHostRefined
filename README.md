...
| [Lurker](#Lurker) | [Mole](#Mole) |  |  |  |  |  | [Nimble](#Nimble) |
...
<img align="right" width="" height="200" src="Images/Impostors/Pitfall.png">
...
<img align="right" width="" height="200" src="Images/Impostors/SoulCatcher.png">
...
<img align="right" width="" height="200" src="Images/Impostors/Visionary.png">
...
<img align="right" width="" height="200" src="Images/Crewmates/TimeMaster.png">
...
<img align="right" width="" height="200" src="Images/Crewmates/Witness.png">
...
<img align="right" width="" height="200" src="Images/Crewmates/Drainer.png">
...
#### Role Description
The Retributionist is a crewmate that can kill anyone after dying, but primarily is used to eliminate Impostors and Neutrals.<br>
There are conditions to being able to use the retribution the Retributionist has.<br>
Those being the fact that if too many have died, retribution may not occur. Another being that the Retributionist may need to finish their tasks to use retribution.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Reverie

<img align="right" width="" height="200" src="Images/Crewmates/Reverie.png">

__Faction__: Crewmate (Killing)<br>
__Base__: Impostor<br>
__Ability__: Become stronger if killing a baddie, or weaker if killing a crewmate<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Eliminate all Impostors<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Reverie is a crewmate that can kill anyone.<br>
If the Reverie kills an evildoer, their cooldown decreases.<br>
If the Reverie kills a cremwate, their cooldown increases.<br>
If the cooldown gets too high, the Reverie may die.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Sheriff

<img align="right" width="" height="200" src="Images/Crewmates/Sheriff.png">

__Faction__: Crewmate (Killing)<br>
__Base__: Impostor<br>
__Ability__: Kill evildoers or misfire<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Eliminate all Impostors<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Sheriff is a crewmate that can kill anyone.<br>
If they try to kill a crewmate or neutral they cannot kill, the Sheriff will misfire.<br>
...
<img align="right" width="" height="200" src="Images/Crewmates/Trickster.png">

__Faction__: Crewmate (Killing)<br>
__Base__: Impostor<br>
__Ability__: Redirect an attack to another player<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Eliminate all Impostors<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Trickster is a crewmate that can trick killers into killing another player.<br>
When the Trickster uses their kill button on a player, that player gets marked.<br>
When someone goes to attack the Trickster after the Trickster marks a player, that someone will instead attack the marked player.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Veteran

<img align="right" width="" height="200" src="Images/Crewmates/Veteran.png">

__Faction__: Crewmate (Killing)<br>
__Base__: Crewmate/Engineer<br>
__Ability__: Kill anyone who interacts with you<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Eliminate all Impostors<br>
__Can Use Pet System__: Yes<br>
...
#### Role Description
The Veteran is a crewmate that can use their vent/pet button to go on alert.<br>
While on alert, the Veteran will kill anyone that interacts with them.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Vigilante

<img align="right" width="" height="200" src="Images/Crewmates/Vigilante.png">

__Faction__: Crewmate (Killing)<br>
__Base__: Crewmate<br>
__Ability__: Guess evil roles in meetings<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Eliminate all Impostors<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Vigilante is a regular crewmate with one added bonus: Guessing!<br>
Guessing is a mechanic where you guess a player's role to kill them.<br>
Guessing wrong kills you instead.<br>
To guess, use the command `/bt [playerId] role` or use the UI if you have the mod installed.<br>
Player IDs are displayed next to player names during meetings.<br>
...
> **Fun Fact!**<br>
> There is an Impostor variant called [Assassin](#Assassin) and a neutral variant called [Doomsayer](#Doomsayer)!
...
<img align="right" width="" height="200" src="Images/Crewmates/Warrior.png">

__Faction__: Crewmate (Killing)<br>
__Base__: Impostor<br>
__Ability__: Kill evildoers or become one<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Eliminate all Impostors<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Warrior is a crewmate that can kill anyone.<br>
If the Warrior kills an Impostor or Neutral, nothing special occurs.<br>
However, if the Warrior kills a crewmate, the Warrior becomes a [Madmate](#Madmate).
...
<img align="right" width="" height="200" src="Images/Neutrals/Amnesiac.png">

__Faction__: Neutral (Benign)<br>
__Base__: Impostor<br>
__Ability__: Remember the role of a dead body<br>
__Indicator/Symbols__: None<br>
__Win Condition__: None<br>
__Can Use Pet System__: No<br>

Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Role Description
The Amnesiac has no win condition. Instead, you must find a dead body and hit the report button.<br>
You will become either the target role (if compatible, otherwise [Engineer](#Engineer)), a Refugee, or a neutral defined in the settings.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Follower.png">

__Faction__: Neutral (Benign)<br>
__Base__: Impostor<br>
__Ability__: Choose a player to win with<br>
__Indicator/Symbols__: None<br>
__Win Condition__: With with the target you choose<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Follower can choose a target with their kill button.<br>
If the target wins, the Follower also wins.<br>
The Follower may change their target as long as they have not died yet.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Hater.png">

__Faction__: Neutral (Benign)<br>
__Base__: Impostor<br>
__Ability__: Can kill evil modifiers<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Kill evil modifiers and win with winning team<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Hater can kill evil modifiers.<br>
If they do so, they win with the winning team.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Lawyer.png">

__Faction__: Neutral (Benign)<br>
__Base__: Crewmate<br>
__Ability__: Help target<br>
__Indicator/Symbols__: Teal diamond next to player name<br>
__Win Condition__: Win with target if target wins<br>
__Can Use Pet System__: No<br>

Origin: Lifeboat<br>

#### Role Description
The Lawyer has an assigned target, much like an [Executioner](#Executioner).<br>
The target is indicated with a teal diamond symbol.<br>
If the target wins, you win as well.<br>
If the target dies, the Lawyer will turn into either a Crewmate, [Jester](#Jester), [Opportunist](#Opportunist), or [Convict](#Convict).
**Beware, if your target is voted off, your role does NOT change!**

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Maverick

<img align="right" width="" height="200" src="Images/Neutrals/Maverick.png">

__Faction__: Neutral (Benign)<br>
__Base__: Impostor<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Win with winning team if alive<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Role Description
The Maverick must survive to the end of the game to win with the winning team, much like an [Opportunist](#Opportunist)<br>
The key difference here is that the Maverick may also kill and vent.<br>
If the Maverick dies, it cannot win.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Opportunist.png">
...
#### Role Description
The Opportunist must survive to the end of the game to win with the winning team<br>
If the Opportunist dies, it cannot win.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Pursuer

<img align="right" width="" height="200" src="Images/Neutrals/Pursuer.png">
...
#### Role Description
The Pursuer must survive to the end of the game to win with the winning team. much like an [Opportunist](#Opportunist)<br>
The Pursuer can use their kill button on any player.<br>
If that player were to use their kill button, they'll misfire.<br>
If the Pursuer dies, it cannot win.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Romantic.png">

__Faction__: Neutral (Benign)<br>
__Base__: Impostor<br>
__Ability__: Pick a partner to win with and protect<br>
__Indicator/Symbols__: Magenta heart<br>
__Win Condition__: Win with your partner<br>
__Can Use Pet System__: No<br>

Origin: [Stellar Roles](https://github.com/Mr-Fluuff/StellarRolesAU)<br>

#### Role Description
The Romantic can choose a partner using their kill button.<br>
After choosing a partner, they can use their kill button to temporarily shield their partner.<br>
The Romantic will win with their partner.<br>
If the partner dies, the Romantic's role will change accordingly.<br>
The possible roles are:<br>
- Refugee (from Impostors)
- Ruthless Romantic (from Neutral Killers)
- Vengeful Romantic (from Crewmates, Neutral Evil, Neutral Benign)

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Shaman

<img align="right" width="" height="200" src="Images/Neutrals/Shaman.png">

__Faction__: Neutral (Benign)<br>
__Base__: Impostor<br>
__Ability__: Reflect attacks onto another player<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Win with winning team if alive<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Shaman can select a player using their kill button to make them their voodoo doll.<br>
All attacks done on the Shaman will be redirected to the voodoo doll.<br>
Effects made by the [Witch](#Witch) will still work on the Shaman.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Unabomber.png">

__Faction__: Neutral (Benign)<br>
__Base__: Engineer<br>
__Ability__: Bomb tasks<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Survive to the end to see the crew lose<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Enhanced](https://github.com/0xDrMoe/TownofHost-Enhanced)<br>

#### Role Description
The Unabomber can do tasks to bomb them.<br>
The next player to complete the bombed task dies, regardless of protection.<br>
If the Unabomber is alive and crew does not win, Unabomber wins!<br>


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## Witch

<img align="right" width="" height="200" src="Images/Neutrals/Witch.png">

__Faction__: Neutral (Benign)<br>
__Base__: Impostor<br>
__Ability__: Make players kill<br>
__Indicator/Symbols__: Purple angled square<br>
__Win Condition__: Survive to the end of the game to see the crew lose<br>
__Can Use Pet System__: No<br>

Origin: Town of Salem<br>

#### Role Description
The Witch can use their kill button to control players, which will cause them to kill the next player they go near.<br>
If the Witch is alive and crew does not win, Witch wins!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Advocate.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: Choose targets<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Get enough points<br>
__Can Use Pet System__: No<br>

Origin: Town of Host Refined<br>

#### Role Description
The Advocate is a neutral role that can choose three targets.<br>
If one is exiled, the Advocate gets a point.<br>
When the Advocate gets the required amount of points, they win!<br>

Optionally, the Advocate may suicide if they don't get one exiled.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Carnivore.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Kill x players<br>
__Can Use Pet System__: No<br>

Origin: Town of Host Refined<br>

#### Role Description
The Carnivore is a neutral that can kill.<br>
If the Carnivore kills enough players, they win!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Collector.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Collect enough votes<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Collector is a neutral that collects votes during meetings.<br>
When the Collector votes someone, any votes on that player will be collected.<br>
When the Collector collects enough total votes, they win!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Cultist.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: Charm others<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Have majority over crewmates<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Cultist is a neutral that wins similarly to neutral killers.<br>
The Cultist can charm other players, converting them to the Cultist team.<br>
If the Cultist has majority over the crew and no other teams are alive, the Cultist wins!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/CursedSoul.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: Make players count as dead<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Steal the win if alive at the end<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Role Description
The Cursed Soul is a neutral that can give players the Soulless modifier, which makes them considered dead.<br>
If the Cursed Soul is alive at the end of the game, the Cursed Soul wins.<br>

The Cursed Soul can see soulless players, but not the other way around.<br>
Souless players can win with the Cursed Soul as well as their original team.<br> 
...
<img align="right" width="" height="200" src="Images/Neutrals/Doomsayer.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate<br>
__Ability__: Guess players in meetings<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Guess enough players to win<br>
__Can Use Pet System__: No<br>

Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Role Description
The Doomsayer is a neutral that has to guess enough players to win.<br>

Guessing is a mechanic where you guess a player's role to kill them.<br>
Guessing wrong may kill you, depending on the settings.<br>
To guess, use the command `/bt [playerId] role` or use the UI if you have the mod installed.<br>
Player IDs are displayed next to player names during meetings.<br>

> **Fun Fact!**<br>
> There is a crewmate variant called [Vigilante](#Vigilante) and an Impostor variant called [Assassin](#Assassin)!
...
<img align="right" width="" height="200" src="Images/Neutrals/Executioner.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Get target voted out<br>
__Can Use Pet System__: No<br>

Origin: Various<br>

#### Role Description
The Executioner is a neutral with a target.<br>
If the target is voted out, the Executioner wins!<br>
If the target dies, the Executioner will turn into either a Crewmate, [Jester](#Jester), [Opportunist](#Opportunist), or [Convict](#Convict).
...
<img align="right" width="" height="200" src="Images/Neutrals/Hacker.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate/Engineer<br>
__Ability__: Fix sabotages faster<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Get enough points from fixing sabotages<br>
__Can Use Pet System__: No<br>

Origin: [Project Lotus](https://https://github.com/ImaMapleTree/Lotus)<br>

#### Role Description
The Hacker is a neutral that has the same abilities as the [Mechanic](#Mechanic) role.<br>
To win, the Hacker must gain enough points from fixing sabotages.<br>
Each sabotage can give different amounts of points.<br>

Optionally, the Hacker may use vents.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Innocent.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: Frame a player for your murder<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Get framed player voted out<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Innocent is a neutral with a simple task: Frame a player for your murder and get them voted out.<br>
To frame a player, use your kill button on them. This will make them kill you.<br>
If the framed player dies, the Innocent cannot win.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Jester.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate/Engineer<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Get voted out<br>
__Can Use Pet System__: No<br>

Origin: Various<br>

#### Role Description
The Jester is a neutral with one goal: Get voted out.<br>
If the Jester dies by any other means, they lose.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Masochist.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate<br>
__Ability__: Basically immortal<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Get attacked a lot<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Plus](https://github.com/Loonie-Toons/TownOfHostPlus)<br>

#### Role Description
The Masochist is a neutral that practically cannot die.<br>
Why? Their win condition is to be attacked a set amount of times to win.<br>

**Note: Guessing the Masochist counts as an attack!**
...
<img align="right" width="" height="200" src="Images/Neutrals/Phantom.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate/Engineer<br>
__Ability__: Basically immortal<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be dead at the end of the game with tasks done<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Role Description
The Phantom is a neutral with the goal of dying and completing their tasks.<br>
If the Phantom has their tasks done and is dead, they'll win.<br>
If the Phantom is alive, they'll lose.<br>

The Phantom will win with the winning team or snatch the win, depending on the settings.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Pirate.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: Dueling<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Win enough duels<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Role Description
The Pirate is a neutral that can duel other players.<br>
To choose a player to duel, use your kill button on them.<br>

In the meeting, you and the target are to use `/duel 0/1/2` to select an option.<br>
If the numbers match, the Pirate wins the duel and kills the target.<br>
If the numbers don't match, the target wins and survives.<br>

Once the Pirate wins enough duels, they win!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Provocateur.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Have target lose<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Provocateur is a neutral that can kill one player.<br>
If that player loses, the Provocateur wins.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Revolutionist.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: Recruit others<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Recruit enough then vent<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Revolutionist is a neutral who must recruit enough players to vent.<br>
If the Revolutionist recruits enough and vents, they win!<br>

Recruited players win with the Revolutionist, alive or dead.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Seeker.png">

__Faction__: Neutral (Evil)<br>
__Base__: Impostor<br>
__Ability__: Seek others<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Get enough seek points<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Role Description
The Seeker is a neutral who plays hide and seek!<br>
The Seeker is given a target, and they must find them to get a point.<br>
However, catching another player will deduct a point.<br>
**Points can go into the negatives, be careful!**<br>

If the Seeker gets enough points, they win!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/SoulCollector.png">
...
#### Role Description
The Soul Collector is a neutral who can predict deaths to get points.<br>
During a meeting, the Soul Collector can vote a player, predicting their death.<br>
If the prediction was correct, the Soul Collector gets a point.<br>
Predict enough deaths to win!<br>

Optionally, the Soul Collector can predict their own death.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Terrorist

<img align="right" width="" height="200" src="Images/Neutrals/Terrorist.png">

__Faction__: Neutral (Evil)<br>
__Base__: Engineer<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Finish tasks, then die<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host](https://github.com/tukasa0001/TownOfHost)<br>

#### Role Description
The Terrorist is a neutral with tasks.<br>
If the Terrorist finishes those tasks then dies, they win!<br>

Whether or not suicide and exile count as valid deaths are dependent on the settings.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Vector

<img align="right" width="" height="200" src="Images/Neutrals/Vector.png">
...
#### Role Description
The Vector is a neutral with a simple goal: Vent enough times.<br>
If the Vector vents enough times without dying, it wins!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Vulture.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate/Engineer<br>
__Ability__: Eat bodies<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Eat enough bodies<br>
__Can Use Pet System__: No<br>

Origin: [TheOtherRoles](https://github.com/TheOtherRolesAU/TheOtherRoles)<br>

#### Role Description
The Vulture is a neutral that can use their report button to eat bodies.<br>
Eating has a cooldown, which means the Vulture can't spam eat. Trying to will result in the Vulture reporting the body.<br>
When the Vulture has eaten enough bodies, it wins!<br>

Eaten bodies cannot be reported.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Workaholic.png">

__Faction__: Neutral (Evil)<br>
__Base__: Crewmate/Engineer<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Finish all tasks<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Role Description
The Workaholic is a neutral who wins if they finish their tasks.<br>
The following can be customized:
- Workaholic may be known to all
- Workaholic can win while dead
...
<img align="right" width="" height="200" src="Images/Neutrals/Agitator.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Timed bombs<br>
__Indicator/Symbols__: None<br>
...
#### Role Description
The Agitator is a neutral that has a bomb they must pass.<br>
Once the bomb is passed, a timer starts.<br>
Players can pass the bomb by going near another player.<br>
When the timer expires, the bomb holder dies.<br>
If a meeting is called, the bomb holder will also die.<br>

Optionally, the Agitator may be able to receive the bomb.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Arsonist.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Dousing<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: Yes<br>
...
#### Role Description
The Arsonist is a neutral that can use their kill button to douse a player.<br>
The Arsonist can kill all doused players by igniting using their vent/pet button.<br>

Optionally, the Arsonist can be changed to its classic counterpart where it is considered a [Neutral Evil](#Neutral-Evil-Roles) role and has to douse everyone to ignite.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Bandit.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Steal modifiers<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Bandit is a neutral that can steal modifiers from other players.<br>
To steal a modifier, use the kill button on a player.<br>
If the player has no stealable modifier, then the Bandit will simply kill the player.<br>

The Bandit cannot steal [Last Impostor](#Last-Impostor).<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/BloodKnight.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Temporal shield<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Blood Knight is a neutral that gains a temporary shield when it kills.<br>
When attacked with the temporary shield active, the Blood Knight is notified.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Demon.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Drain health<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Demon is a neutral with a health system.<br>
When the Demon attacks a player, their health is reduced.<br>
The same occurs vice versa.<br>
Players attacking the Demon will be notified that they attacked a Demon.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Glitch.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Mimic, Hack<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: Yes<br>
...
#### Role Description
The Glitch is a neutral that can kill, hack, and mimic.<br>
Killing is what you'd expect.<br>
Hacking is the equivalent to a roleblock.<br>
Mimicking causes the Glitch to transform into a random living player.<br>
You can mimic by either using the Sabotage menu or by using the Pet button.<br>

The kill button is always at a cooldown of 1 second as killing and hacking are both mapped to the same button.<br>
The kill cooldown and hack cooldown are visualized so you know what's on cooldown.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Harbinger.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Kill nearby players on kill<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Harbinger is a neutral that, when it kills, also kills nearby players with the kill reason "Obliterated".
...
<img align="right" width="" height="200" src="Images/Neutrals/Huntsman.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Reduce kill cooldown when killing a target<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Huntsman is a neutral with targets.<br>
If the Huntsman kills one, their kill cooldown is decreased.<br>
If the Huntsman kills anyone else, their kill cooldown is increased.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Illusioner.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Transform into another player<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Illusioner is a neutral that can change their appearance.<br>
To mirror the appearance of a living player, use your kill button once on them.<br>
You'll become them after a second or two.<br>

To kill normally, click the kill button once.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Infectious.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Infect others onto your team<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Infectious is a neutral that can infect players.<br>
Infected players are on the Infectious team.<br>

If the Infectious infects all the remaining killers, the Infectious just has to outnumber the crew to win.<br>

If the Infectious dies, all infected players will die after the next meeting.<br>
If the infected players complete the Infectious win condition before then, the Infectious team can still win.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Jackal.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Recruit a Sidekick<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Jackal is a neutral that can recruit a Sidekick to help them win.<br>
Sidekicks are on the Jackal's team.<br>

The Jackal and Sidekick can optionally sabotage like an Impostor, and can optionally win by sabotage if all the Impostors are dead.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Jinx.png">
...
#### Role Description
The Jinx is an Impostor that, when attacked, reflects nearly any attack onto the source.<br>
The attack type will either appear as a misfire or a [Veteran](#Veteran) kill, depending on the settings.
...
<img align="right" width="" height="200" src="Images/Neutrals/Juggernaut.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Decreasing kill cooldown<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Juggernaut is a neutral that reduces their kill cooldown when it kills.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Medusa.png">
...
#### Role Description
The Medusa is an Impostor that can stone bodies, making the unreportable.<br>
If the Medusa's kill cooldown is up, their report button will be their stone button.<br>
If the kill cooldown is not up, the report button functions as a report button.<br>

Stoning a body resets the kill cooldown.<br>

> **Fun Fact!**<br>
> There is an Impostor variant called [Janitor](#Janitor)!<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Necromancer

<img align="right" width="" height="200" src="Images/Neutrals/Necromancer.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Defy death<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Necromancer is a neutral that, when attacked, gets another chance at life.<br>
The Necromancer then enters a necromancy, where the Necromancer has to go and kill the attacker.<br>
During a necromancy, venting is disabled to prevent hiding inside a vent.<br>

If the timer runs out for the necromancy, the Necromancer dies.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Pelican.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Eat players alive<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Pelican is a neutral that eats players rather than immediately killing them.<br>
When a player is eaten by the Pelican, they are teleported outside the map out of view for the remainder of the round.<br>
If the Pelican dies, all eaten players are teleported to the position of the Pelican.<br>
If a meeting is called, all eaten players die.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Pickpocket.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Gain votes by killing<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Pickpocket is a neutral with the same ability as the [Stealer](#Stealer) modifier.<br>
When the Pickpocket kills, they gain votes.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Poisoner

<img align="right" width="" height="200" src="Images/Neutrals/Poisoner.png">
...
#### Role Description
The Poisoner is a neutral that has delayed kills.<br>
The kill button is the poison button, which will cause the victim to die after a set amount of time.<br>

> **Fun Fact!**<br>
> There is an Impostor variant called [Vampire](#Vampire)!

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Plaguebearer

<img align="right" width="" height="200" src="Images/Neutrals/Plaguebearer.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Spread the plague<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Turn into Pestilence and be the last man standing<br>
__Can Use Pet System__: No<br>

Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Role Description
The Plaguebearer is a neutral that can use their kill button to spread the plague among the crew.<br>
Once every living player is infected, the Plaguebearer becomes Pestilence.<br>

As Pestilence, you are virtually invincible, killing anyone who tries to kill you.<br>
Once you outnumber the crew, you win.<br>

Pestilence cannot be guessed, attempting to do so causes the source of the guess to die.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/PotionMaster.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Reveal roles to self<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Potion Master is a neutral that can reveal the roles of other players to themself.<br>
To reveal, use the kill button once.<br>
To kill, click it twice.<br>

The Potion Master can also sabotage like an Impostor, but cannot win by sabotage.<br>
...
#### Role Description
The Pyromaniac is a neutral that can both kill players, as well as douse them.<br>
To douse, click the kill button once.<br>
To kill, click it twice.<br>

If the Pyromaniac kills a doused player, they will receive a reduced kill cooldown for their next kill.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/SerialKiller.png">
...
#### Role Description
The Serial Killer is a neutral with no unique ability.<br>
It's a basic killer with its goal being for everyone to die.<br>

Optionally, the Serial Killer can have a teammate.<br>
**This second Serial Killer can replace any role that spawns, including an Impostor!**
...
<img align="right" width="" height="200" src="Images/Neutrals/Shroud.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Make others kill<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Shroud is a neutral that functions identically to the [Witch](#Witch).<br>
Shrouded players kill the next player they go near, but die if they don't.<br>

The Shroud cannot kill directly.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Stalker.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Call lights on kill<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Stalker is a neutral that calls lights when it kills.<br>
If win snatching is enabled, it'll win if crewmates or impostors win while the Stalker is alive.<br>

**Note: Stalker cannot spawn on the Fungle due to the lack of a lights sabotage.**
...
<img align="right" width="" height="200" src="Images/Neutrals/Traitor.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: See Impostors<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Traitor is a neutral that functions as a former Impostor.<br>
They play exactly like a regular Impostor would, and can even see the other Impostors.<br>
However, the Traitor cannot kill the Impostors.<br>
The Traitor must eliminate the Impostors by any other means.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Virus.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Infect others<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Virus is a neutral that spreads an infection onto its kills.<br>
When someone reports an infected body, they'll either join the Virus team or die if the Virus is not exiled, depending on the settings.<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Werewolf.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Rampage<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: Yes (Required)<br>
...
#### Role Description
The Werewolf is a neutral that can only kill while on rampage.<br>
To start a rampage, pet your pet.<br>

While on rampage, the Werewolf has a low kill cooldown.<br>
Rampaging has a duration so use it wisely!<br>
...
<img align="right" width="" height="200" src="Images/Neutrals/Wraith.png">

__Faction__: Neutral (Killing)<br>
__Base__: Impostor<br>
__Ability__: Temporaril go invisible<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Be the last man standing<br>
__Can Use Pet System__: No<br>
...
#### Role Description
The Wraith is an Impostor that can temporarily turn invisible by venting.<br>
While invisible, you can kill in plain sight without being seen.<br>
If you vent while invisible, you'll stop being invisible prematurely.<br>

> **Fun Fact!**<br>
> There is a crewmate variant called [Chameleon](#Chameleon) and an Impostor variant called [Swooper](#Swooper)!<br>
...
<img align="right" width="" height="200" src="Images/Madmates/Convict.png">

__Faction__: Madmate<br>
__Base__: Crewmate<br>
__Ability__: None<br>
__Indicator/Symbols__: None<br>
__Win Condition__: Wins with Impostors<br>
__Can Use Pet System__: No<br>

Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Role Description
The Convict is a madmate that can spawn when an [Executioner](#Executioner)'s target or a [Lawyer](#Lawyer)'s target dies.<br>

**Note: Convict cannot spawn at the start of the game.**<br>
...
<img align="right" width="" height="200" src="Images/Madmates/Crewpostor.png">
...
#### Role Description
The Crewpostor is a madmate that kills the closest player to them when they complete a task.<br>

Optionally, the Crewpostor may know the other Impostors and vice versa.<br>
Additionally, you may be able to kill the Impostors accidentally.<br>
...
<img align="right" width="" height="200" src="Images/Madmates/Parasite.png">
...
#### Role Description
The Parasite is a madmate that plays identically to an Impostor, with the only difference being that both the Parasite and the Impostors do not know each other.<br>
...
<img align="right" width="" height="200" src="Images/Madmates/Refugee.png">
...
#### Role Description
The Refugee is a madmate that functions identically to an Impostor.<br>

For a Refugee to spawn, an [Amnesiac](#Amnesiac) would have to find an Impostor's body **OR** you'd have to have killed the [Godfather](#Godfather)'s target.<br>

**Note: Refugee cannot spawn at the start of the game.**<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Antidote.png">

__Type__: Mixed (Global)<br>
__Ability__: Decrease cooldown of interaction source<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Antidote is a modifier that reduces the cooldown of the interaction target.

> For the opposite, see [Diseased](#Diseased).
...
<img align="right" width="" height="200" src="Images/Modifiers/Autopsy.png">

__Type__: Helpful (Global)<br>
__Ability__: See how others had died<br>


Origin: [TOHY](https://github.com/Yumenopai/TownOfHost_Y)<br>

#### Modifier Description
Autopsy is a helpful modifier that allows the player to see how people had died.<br>

> Fun Fact!<br>
> Autopsy is [Doctor](#Doctor) as a modifier.
...
<img align="right" width="" height="200" src="Images/Modifiers/Avenger.png">

__Type__: Mixed (Global)<br>
__Ability__: Take one player down with you<br>


Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Modifier Description
Avenger is a modifier that kills a random alive player when you die.
...
<img align="right" width="" height="200" src="Images/Modifiers/Aware.png">

__Type__: Mixed (Global)<br>
__Ability__: Know if your role is revealed<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Aware is a modifier that tells you if your role gets revealed to someone
...
<img align="right" width="" height="200" src="Images/Modifiers/Bait.png">

__Type__: Helpful (Global)<br>
__Ability__: Force self report on your body<br>


Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Modifier Description
Bait is a helpful modifier that causes the killer to automatically self report.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Beartrap

<img align="right" width="" height="200" src="Images/Modifiers/Beartrap.png">

__Type__: Helpful (Global)<br>
__Ability__: Freeze killer in place<br>


Origin: [Town of Host](https://github.com/tukasa0001/TownOfHost)

#### Modifier Description
Beartrap is a helpful modifier that sticks the player in place for a set amount of time.<br>
Trying to report bodies in this state will delay the report until after the effect wears off.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Bewilder

<img align="right" width="" height="200" src="Images/Modifiers/Bewilder.png">

__Type__: Helpful (Global)<br>
__Ability__: Cursed vision<br>


Origin: [Project Lotus](https://github.com/ImaMapleTree/Lotus/)<br>

#### Modifier Description
Bewilder is a helpful modifier that gives the player modified vision (generally lower).<br>
When the Bewilder is killed, the vision is transferred over to the killer.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Bloodlust.png">

__Type__: Mixed (Crew Only)<br>
__Ability__: Kill the next player you go near after doing a task<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Bloodlust is a modifier that allows the player to kill the next player they go near after completing a task.<br>
Effect does not stack and does not clear after a meeting.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Bloody.png">

__Type__: Helpful (Global)<br>
__Ability__: Turn killer's name red temporarily<br>


Origin: [TheOtherRoles](https://github.com/TheOtherRolesAU/TheOtherRoles)<br>

#### Modifier Description
Bloody is a helpful modifier that, when killed, causes the killer's name to turn a dark red.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Burst

<img align="right" width="" height="200" src="Images/Modifiers/Burst.png">

__Type__: Helpful (Global)<br>
__Ability__: Make killer explode after a set time<br>


Origin: [Town of Host Plus](https://github.com/Loonie-Toons/TownOfHostPlus)<br>

#### Modifier Description
Burst is a helpful modifier that, when killed, causes their killer to explode if they aren't inside a vent when the time expires.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Circumvent.png">

__Type__: Impostor (Limited)<br>
__Ability__: Remove vent ability<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Circumvent is an Impostor modifier that removes the vent ability.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Clumsy.png">

__Type__: Impostor (Limited)<br>
__Ability__: Chance to miss kill<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Clumsy is an Impostor modifier that gives the given Impostor a chance to miss their kill.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Consenses.png">

__Type__: Harmful (Global)<br>
__Ability__: Can't control vote<br>


Origin: Town of Host Refined<br>

#### Modifier Description
Consenses is a modifier that doesn't allow you to control your vote.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Cyber.png">

__Type__: Helpful (Global)<br>
__Ability__: Visible to all and can't be killed in a group<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Cyber is a helpful modifier that, when killed, notifies any eligible factions of their death.<br>
If the Cyber is with more than one person, they cannot be directly attacked.<br>
Additionally, the Cyber may or may not be known to all.<br>

> **Fun Fact!**<br>
> Cyber is [Celebrity](#Celebrity) and [Super Star](#Super-Star) merged together into a modifier.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Democrat.png">

__Type__: Helpful (Global)<br>
__Ability__: Extra vote(s)<br>

Origin: Town of Host Refined<br>

#### Modifier Description
Democrat is a helpful modifier that gives the user extra votes.

> **Fun Fact!**<br>
> Democrat is [Mayor](#Mayor) as a modifier.
...
<img align="right" width="" height="200" src="Images/Modifiers/Diseased.png">

__Type__: Mixed (Global)<br>
__Ability__: Increase cooldown of interaction source<br>


Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Modifier Description
Diseased is a modifier that increases the cooldown of the interaction target.

> For the opposite, see [Antidote](#Antidote).
...
<img align="right" width="" height="200" src="Images/Modifiers/Disregarded.png">

__Type__: Harmful (Global)<br>
__Ability__: Block body report<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Disregarded is a modifier that makes your body unreportable.<br>

> **Not what you were looking for?**<br>
> Maybe [Oblivious](#Oblivious) is what you were looking for!<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/DoubleShot.png">

__Type__: Helpful (Limited)<br>
__Ability__: Second chance at guessing<br>


Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Modifier Description
Double Shot is a helpful modifier that gives the assigned player a second chance when guessing.<br>
When guessing [Rebound](#Rebound), you'll die regardless.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Egoist.png">

__Type__: Misc. (Limited)<br>
__Ability__: Win alone<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Egoist is a modifier that causes you to win alone if your team wins with you alive.<br>
You win with your original team if you're dead.<br>

Other Egoists on the same faction (Crewmate/Impostor) also win with you.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Fragile.png">

__Type__: Harmful (Global)<br>
__Ability__: Die on any interaction<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Fragile is a modifier that causes the player to die when interacted with.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Flash.png">

__Type__: Helpful (Global)<br>
__Ability__: Multiplied speed<br>


Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Modifier Description
Flash is a modifier that multiples the player's base speed.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Ghoul.png">

__Type__: Mixed (Crew Only)<br>
__Ability__: Kill your killer after dying<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Ghoul is a modifier that makes the player kill their killer when they finish their tasks.<br>
However, if the Ghoul finishes their tasks, they'll suicide.<br>

**Note: Task win is prioritized over a majority win (Impostor Win, Neutral Killer Win) if the Ghoul were to finish tasks while alive.**
...
<img align="right" width="" height="200" src="Images/Modifiers/Gravestone.png">

__Type__: Mixed (Global)<br>
__Ability__: Reveal your role after dying<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Gravestone is a modifier that reveals your role to everyone when you die.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Guesser.png">
...
#### Modifier Description
Guesser is a modifier that grants the ability to guess, much like an [Assassin](#Assassin) or [Vigilante](#Vigilante).<br>

Guessing is a mechanic where you guess a player's role to kill them.<br>
Guessing wrong kills you instead.<br>
To guess, use the command `/bt [playerId] role`.<br>
Player IDs are displayed next to player names during meetings.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/LastImpostor.png">

__Type__: Impostor (Global)<br>
__Ability__: Lower kill cooldown<br>


Origin: [Town of Host](https://github.com/tukasa0001/TownOfHost)<br>

#### Modifier Description
Last Impostor is a modifier assigned to the last Impostor alive.<br>
It grants a lower kill cooldown.<br>

Not assigned if the last Impostor has the [Overclocked](#Overclocked) modifier.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Lazy.png">

__Type__: Helpful (Crew Only)<br>
__Ability__: Control immunity<br>
...
#### Modifier Description
Lazy is a helpful modifier that gives the player one short task and makes them immune to all immunity except [Witch](#Witch).

> **Fun Fact!**<br>
> Lazy is [Lazy Guy](#Lazy-Guy) as a modifier.

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Lovers

<img align="right" width="" height="200" src="Images/Modifiers/Lovers.png">

__Type__: Misc. (Global)<br>
__Ability__: Win together if alive at game end<br>


Origin: [Town of Host](https://github.com/tukasa0001/TownOfHost)<br>

#### Modifier Description
Lovers is a modifier that spawns twice, for a pair of two players, being lovers.<br>
If one dies, the other does as well.<br>
If the game ends and they are both alive, they win solo.<br>

Lovers can also win together via other means.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Loyal.png">

__Type__: Helpful (Limited)<br>
__Ability__: Immune to team changes<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Loyal is a helpful modifier that prevents any and all alignment changes on the player.<br>
Can not be assigned to Neutrals.<br>

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

## Lucky

<img align="right" width="" height="200" src="Images/Modifiers/Lucky.png">

__Type__: Helpful (Global)<br>
__Ability__: Able to dodge attacks<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Lucky is a helpful modifier that allows the player to dodge attacks on a percentage.<br>
This can also prevent certain other abilities to be dodged, as long as they're executed by the kill button.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Madmate.png">

__Type__: Impostor (Crew Only)<br>
__Ability__: Change alignment to Impostor<br>


Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Modifier Description
Madmate is a modifier that makes the assigned crewmate on the Impostor team.<br>

Madmate can be assigned to neutrals via [Gangster](#Gangster).
...
<img align="right" width="" height="200" src="Images/Modifiers/Mare.png">

__Type__: Impostor (Limited)<br>
__Ability__: Only kill during lights, speed boost during lights<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Mare is an Impostor modifier that makes it so the assigned Impostor can only ever kill during lights.<br>
Additionally, they gain a speed boost during lights.<br>
Beware, your name also turns red during lights!<br>

**Note: Mare cannot spawn on the Fungle due to the lack of a lights sabotage.**
...
<img align="right" width="" height="200" src="Images/Modifiers/Mimic.png">

__Type__: Impostor (Global)<br>
__Ability__: Reveal dead roles to yourself, reveal what you killed to teammates<br>


Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Modifier Description
Mimic is an Impostor modifier that keeps track of what roles you killed, and tells them to the rest of your team once you die.<br>

Optionally, you can see all dead roles.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Necroview.png">

__Type__: Helpful (Global)<br>
__Ability__: See the factions of the dead<br>


Origin: [Town of Host Plus](https://github.com/Loonie-Toons/TownOfHostPlus)<br>

#### Modifier Description
Necroview is a helpful modifier that allows seeing the alignments of dead players.<br>
- Red means Impostor or Madmate
- Cyan means Crewmate
- Gray means Neutral
...
<img align="right" width="" height="200" src="Images/Modifiers/Nimble.png">

__Type__: Helpful (Limited)<br>
__Ability__: Unlock vent ability<br>


Origin: [Project Lotus](https://github.com/ImaMapleTree/Lotus/)<br>

#### Modifier Description
Nimble is a helpful modifier that grants the ability to vent.<br>
Only ever assigned to crewmates that do not have completable tasks.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Oblivious.png">

__Type__: Harmful (Global)<br>
__Ability__: Block reporting bodies<br>


Origin: [Project Lotus](https://github.com/ImaMapleTree/Lotus)<br>

#### Modifier Description
Oblivious is a modifier that disables the use of the report button.<br>

> **Not what you were looking for?**<br>
> Maybe [Disregarded](#Disregarded) is what you were looking for!<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Overclocked.png">

__Type__: Helpful (Limited)<br>
__Ability__: Reduced cooldown<br>


Origin: [Town of Host Plus](https://github.com/Loonie-Toons/TownOfHostPlus)<br>

#### Modifier Description
Overclocked is a helpful modifier that reduces the cooldown of whatever the kill button is by a set percentage.<br>
Only assigned to roles with a kill button and is not [Glitch](#Glitch) or [Amnesiac](#Amnesiac).<br>
Removed from Impostors if that Impostor is assigned [Last Impostor](#Last-Impostor).
...
<img align="right" width="" height="200" src="Images/Modifiers/Repairman.png">

__Type__: Helpful (Global)<br>
__Ability__: Repair many sabotages alone and quickly<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Repairman is a helpful modifier that allows fixing sabotages very quickly.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Sleuth.png">

__Type__: Helpful (Global)<br>
__Ability__: Role details on your reports<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Stealer.png">

__Type__: Impostor (Global)<br>
__Ability__: Gain votes from kills<br>


Origin: [Town of Host Edited](https://github.com/KARPED1EM/TownOfNext)<br>

#### Modifier Description
Stealer is an Impostor modifier that gives the Impostor votes in exchange for kills.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Stubborn.png">

__Type__: Mixed (Global)<br>
__Ability__: Block changes to your role and modifiers<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Stubborn is a modifier that makes it so [Eraser](#Eraser) cannot erase your role, [Bandit](#Bandit) cannot steal from you, and [Monarch](#Monarch) cannot knight you.<br>
Additionally, you cannot be sold modifiers by the [Merchant](#Merchant).
...
<img align="right" width="" height="200" src="Images/Modifiers/Swift.png">

__Type__: Impostor (Limited)<br>
__Ability__: No lunge when killing<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Swift is an Impostor modifier that makes it so you don't lunge when killing.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Tiebreaker.png">

__Type__: Helpful (Global)<br>
__Ability__: Break tied votes<br>


Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Modifier Description
Tiebreaker is a helpful modifier that prioritizes your vote if your vote is involved in a tie.<br>
If there are multiple Tiebreakers in a tie, the Tiebreaker does not go into effect.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Torch.png">

__Type__: Helpful (Crew Only)<br>
__Ability__: Better vision<br>


Origin: [Town of Us Reactivated](https://github.com/eDonnes124/Town-Of-Us-R)<br>

#### Modifier Description
Torch is a helpful modifier that enhances the player's vision.<br>
May be affected by the lights sabotage, depending on the settings.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Unlucky.png">

__Type__: Harmful (Global)<br>
__Ability__: Chance to suicide when doing actions<br>


Origin: [Town of Host Re-Edited](https://github.com/Loonie-Toons/Re-Edited)<br>

#### Modifier Description
Unlucky is a modifier that causes you to have a configurable chance to die from the following:
- Completing tasks
- Killing others
- Using vents
- Reporting bodies
...
<img align="right" width="" height="200" src="Images/Modifiers/VIP.png">

__Type__: Misc. (Crew Only)<br>
__Ability__: Kill all crewmates if you die<br>


Origin: Town of Host Refined<br>

#### Modifier Description
VIP is a modifier that's both helpful to the crew but also quite dangerous.<br>
All crewmates know who the VIP is, but will all die if the VIP dies.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/VoidBallot.png">

__Type__: Hamrful (Global)<br>
__Ability__: Kill all crewmates if you die<br>
...
#### Modifier Description
Void Ballot is a modifier that makes the player have no votes at all.<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Watcher.png">

__Type__: Helpful (Global)<br>
__Ability__: See through anonymous votes<br>


Origin: [Town of Host](https://github.com/tukasa0001/TownOfHost)

#### Modifier Description
Watcher is a helpful modifier that allows seeing through anonymous votes.<br>
This can also see any extra votes (if set to be visible).<br>
...
<img align="right" width="" height="200" src="Images/Modifiers/Workhorse.png">

__Type__: Misc (Crew Only)<br>
__Ability__: Extra tasks<br>


Origin: [Town of Host](https://github.com/tukasa0001/TownOfHost)

#### Modifier Description
Workhorse is a modifier that is assigned to the first alive crewmate to finish all their tasks.<br>
Optionally, the [Snitch](#Snitch) can also recieve Workhorse.
